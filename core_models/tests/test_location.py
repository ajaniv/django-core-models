"""
.. module::  core_models.test_location
   :synopsis: core models location unit test module.

*core models* location unit test module.
"""
...
class GeographicLocationModelFactory(VersionedModelFactory):
...
class GeographicLocationTestCase(VersionedModelTestCase):
